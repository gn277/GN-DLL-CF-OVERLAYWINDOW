...
//换弹搜5，没换搜2
//主武器0，副武器1，近战2，雷3
#define InjectHookOffset 0x1BB884								//dll注入点					特征码：45 33 C9 C7 44 24 ?? 01 00 00 00 45 33 C0 48 ?? ?? ?? 33 D2 FF 15 ?? ?? ?? ?? 85 C0 75 ?? E8 ?? ?? ?? ?? 85 C0
...
#define Hitchaddress 0x1403B4A84								//绘制挂接地址				特征码：45 33 C9 45 33 C0 33 D2 E9 ?? ?? ?? ?? FF 15 ?? ?? ?? ?? 8B D8 
