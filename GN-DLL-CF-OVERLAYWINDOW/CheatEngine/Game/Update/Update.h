...
#define Mtrix 0x1405245E0										//矩阵						特征码：F3 0F 10 83 ?? ?? ?? ?? F3 0F 10 8B ?? ?? ?? ?? 48 8B 4B ?? 48 85 C9 0F 84 ?? ?? ?? ?? 44 8B 81 ?? ?? ?? ??  [rbx + 0x2D00]-0x10
#define ArraySizeOffset 0x1048									//数组大小
#define PlayerArrayBaseAddress 0x2A98498						//玩家数组
#define ModelOffset 0x2A984C8									//判断模式
#define ModelOffset2 0x2A9840E									//模式基址
...
#define SilentTrackAddress 0x140234390							//静默追踪构造				特征码：48 83 EC 28 0F 28 C2 4C 8B CA F3 0F 10 54 24 ?? 
...
#define KnifeDistanceBaseAddress 0x2C3BDC0						//刀距基址 | 武器基址
